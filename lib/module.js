...
function requireNative (id, cb) {
  ...
  var mod = new exports.Module(id, null, null, id);
...
function requireResolved (parent, uri, cache, cb) {
  ...
  var child = new exports.Module(uri, parent, cache);
...
function main (uri) {
  ...
  process.mainModule = new exports.Module(uri, null, null, ".");
...
function Module (uri, parent, cache, id) {
  ...
  if (parent) {
    ...
    this.moduleCache = cache || parent.moduleCache;
  } else {
