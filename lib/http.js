...
IncomingMessage.prototype._parseQueryString = function () {
  process.stdio.writeError("WARNING: _parseQueryString is deprecated. Use require(\"querystring\") to parse query strings.\n");
};
...
exports.cat = function (url, encoding, headers) {
  ...
  var client = exports.createClient(url.port || 80, url.domain);
  var req = client.request(url.path || "/", headers);
