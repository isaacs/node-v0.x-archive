process.stdio.writeError("WARNING: uri module is deprecated. Please use require(\"url\") instead.\n");
...
[
  uri_parse, uri_format, uri_resolve, uri_resolveObject, uri_decode
].forEach(function (f) {
  var n = f.name.substr(4)
  exports[n] = function () {
    process.stdio.writeError("WARNING: uri module is deprecated. Please use require(\"url\") instead.\n");
