...
assert.equal(path.join(__dirname, "../fixtures/a.js"), require.resolve("../fixtures/a"));
assert.equal(path.join(fixturesDir, "a.js"), require.resolve(path.join(fixturesDir, "a")));
